...
// ----------------------------------------------------------------------------
// Version 1.2 2018/3/12
// 
//
// ■更新履歴
// 1.2 2018/3/12　ヘルプの表示内容をデフォルトに戻したときに生じていた不具合を修正。
// 1.1 2018/3/10  各シーンにつきヘルプスタイルを2パターンまで登録できるように変更。
// 1.0 2018/3/9   初版作成。
// 
//
//=============================================================================
/*:
* @plugindesc v1.1 ヘルプウィンドウの行数や表示形式をカスタマイズします。
*
* @author いず
*
* @param ---ItemHelpStyle---
